...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      // group statuses per user (newest first already)
      ...
      // author meta for followed users that have never posted a status
      ...
      // own channel always first if stories exist
      ...
      // strictly the channels you follow — unfollow = gone from this rail
      const withStories = [];
