...
import { Eye, Hash, Heart, Leaf, TrendingUp, UserPlus, Users } from 'lucide-react';
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] text-ink-500 mt-0.5 flex items-center gap-2">
                  ...
                  {p.media_type === 'video' && (
                    <span className="inline-flex items-center gap-1">
                      <Eye size={10} /> {compact(p.views_count)}
                    </span>
                  )}
                </p>
              </div>
      ...
      {taste.length > 0 && (
        <section>
          ...
          <p className="text-[11px] text-ink-500 mt-2 leading-relaxed">
            Learned live from what you linger on, keep and search — the feed rewires itself around these threads.
          </p>
