...
import { Plus, Send, Bell, UsersRound, Sparkles, X, Moon, Sun } from 'lucide-react';
...
export default function MobileShell() {
  ...
  return (
    <div className="flex flex-col overflow-hidden bg-transparent" style={{ height: 'var(--vvh, 100%)' }}>
      <header className="shrink-0 flex items-center justify-between px-4 pt-3 pb-2 border-b border-gold-500/20 bg-black/50 backdrop-blur-xl z-30">
        ...
        <div className="flex items-center gap-0.5">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full text-gold-500 hover:bg-gold-400/15 transition-colors"
      ...
      <main className="flex-1 min-h-0 overflow-y-auto overscroll-contain relative no-scrollbar">
