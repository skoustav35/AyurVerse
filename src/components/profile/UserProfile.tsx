          ...
          <div className="card-warm p-4">
            <div className="flex items-start gap-3.5">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                <div className="flex items-center gap-4 mt-3 text-[11.5px] text-ink-500 flex-wrap">
                  ...
                  <button
                    ...
                    className="hover:text-saffron-700 transition-colors cursor-pointer text-left"
                  >
                    <b className="text-ink-900 font-semibold">{compact(profileData?.followers_count ?? 0)}</b> followers
                  </button>
                  <button
                    onClick={() => setFollowModal('following')}
                    className="hover:text-saffron-700 transition-colors cursor-pointer text-left"
                  >
                    <b className="text-ink-900 font-semibold">{compact(profileData?.following_count ?? 0)}</b> following
                  </button>
