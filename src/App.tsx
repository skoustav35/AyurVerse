...
function Root() {
  ...
  // Landing and the auth gateway are light-only — the stored preference only takes
  // effect once the app shell mounts. Layout effect so the swap lands before paint.
  useLayoutEffect(() => {
